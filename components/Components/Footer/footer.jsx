                        ...
                        <div className="row row-cols-lg-4 row-cols-md-2 row-cols-1 grid-spacer-5">
                            ...
                            <div className="col col-lg-2">
                                <div className="footer-quick-links">
                                    ...
                                    <ul className="footer-list">
                                        ...
                                        <li><Link href="/about" onClick={() => typeof window !== 'undefined' && window.scrollTo({ top: 0, behavior: 'instant' })}>About Us</Link></li>
                                        <li><Link href="/service" onClick={() => typeof window !== 'undefined' && window.scrollTo({ top: 0, behavior: 'instant' })}>Service</Link></li>
                                        {/* <li><Link href="/case-studies">Case Studies</Link></li> */}
                                        <li><Link href="/portfolio" onClick={() => typeof window !== 'undefined' && window.scrollTo({ top: 0, behavior: 'instant' })}>Portfolio</Link></li>
                            ...
                            <div className="col col-lg-3">
                                <div className="footer-services-container">
                                    <h5>Services</h5>
                                    <ul className="footer-list">
                                        <li><Link href="/service" onClick={() => typeof window !== 'undefined' && window.scrollTo({ top: 0, behavior: 'instant' })}>Funnel & Landing Page Design</Link></li>
                                        <li><Link href="/service" onClick={() => typeof window !== 'undefined' && window.scrollTo({ top: 0, behavior: 'instant' })}>CRM & Pipeline Setup</Link></li>
                                        <li><Link href="/service" onClick={() => typeof window !== 'undefined' && window.scrollTo({ top: 0, behavior: 'instant' })}>Automation & Workflow</Link></li>
                                        <li><Link href="/service" onClick={() => typeof window !== 'undefined' && window.scrollTo({ top: 0, behavior: 'instant' })}>White-Label Agency Builds</Link></li>
                                        <li><Link href="/service" onClick={() => typeof window !== 'undefined' && window.scrollTo({ top: 0, behavior: 'instant' })}>Integrations & AI Enablement</Link></li>
                                        <li><Link href="/service" onClick={() => typeof window !== 'undefined' && window.scrollTo({ top: 0, behavior: 'instant' })}>Chatbots & Voice Agents</Link></li>
                                        <li><Link href="/service" onClick={() => typeof window !== 'undefined' && window.scrollTo({ top: 0, behavior: 'instant' })}>Lead Capture & Nurture</Link></li>
                                        <li><Link href="/service" onClick={() => typeof window !== 'undefined' && window.scrollTo({ top: 0, behavior: 'instant' })}>Support & Maintenance</Link></li>
                                    </ul>
                                </div>
                            </div>
