    ...
    return (
        ...
        <div ref={sidebarRef} className="sidebar">
            ...
            <ul className="menu">
                ...
                <li><Link to="/about" onClick={() => { window.scrollTo({ top: 0, behavior: 'instant' }); }}>About</Link></li>
                <li><Link to="/service" onClick={() => { window.scrollTo({ top: 0, behavior: 'instant' }); }}>Services</Link></li>
                <li className="sidebar-dropdown">
                    ...
                    <ul className="sidebar-dropdown-menu">
                        <li><Link to="/team" onClick={() => { window.scrollTo({ top: 0, behavior: 'instant' }); }}>Our Team</Link></li>
                        <li><Link to="/pricing" onClick={() => { window.scrollTo({ top: 0, behavior: 'instant' }); }}>Pricing Plan</Link></li>
                        <li><Link to="/testimonial" onClick={() => { window.scrollTo({ top: 0, behavior: 'instant' }); }}>Testimonial</Link></li>
                    </ul>
                </li>
